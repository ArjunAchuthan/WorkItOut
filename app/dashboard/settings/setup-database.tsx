  ...
  return (
    <div className="space-y-4">
      ...
      <div className="rounded-md bg-muted p-4">
        <p className="text-sm font-medium mb-2">Manual Setup Instructions:</p>
        <ol className="list-decimal space-y-1 pl-5 text-sm text-muted-foreground">
          ...
          <li>Create a new database named "workitout_db"</li>
          <li>Select the database and go to the "Import" tab</li>
          <li>Upload the SQL script file (setup-xampp-db.sql)</li>
