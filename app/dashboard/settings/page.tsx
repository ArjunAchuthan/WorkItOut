                    ...
                    <div className="space-y-6">
                      <div className="flex items-center justify-between">
                        <div className="space-y-0.5">
                          ...
                          <p className="text-sm text-muted-foreground">Receive reminders for upcoming workouts</p>
                        </div>
                        <Switch
                      ...
                      <div className="flex items-center justify-between">
                        <div className="space-y-0.5">
                          ...
                          <p className="text-sm text-muted-foreground">Get notified about your fitness progress</p>
                        </div>
                        <Switch
                          id="progress-updates"
              ...
              <TabsContent value="appearance">
                <Card className="dashboard-tile">
                  <CardHeader className="pb-2">
                    ...
                    <CardDescription>Customize how WorkItOut looks for you</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-6">
                      <div className="space-y-2">
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                          ...
                          <p className="text-sm text-muted-foreground pl-7">
                            Help us improve WorkItOut by allowing anonymous usage data collection
                          </p>
                        </div>
                      </div>
              ...
              <TabsContent value="database">
                <Card className="dashboard-tile">
                  <CardHeader className="pb-2">
                    ...
                    <CardDescription>Verify the connection to the MySQL database</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <DbConnectionTest />
                  </CardContent>
